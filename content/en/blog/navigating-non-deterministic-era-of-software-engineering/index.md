...
Recently, Martin Fowler sat down for an interview on *The Pragmatic Engineer* podcast, and his observations perfectly articulate the quiet crisis happening in modern development cycles. Fowler posits that the rise of AI in software engineering is the most disruptive change since our industry transitioned from assembly to high-level languages. But the true nature of this shift is heavily misunderstood.
